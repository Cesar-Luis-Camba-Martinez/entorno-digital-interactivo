...
function dibujarPlano() {
  ...
  // Delimitación clara y bien posicionada de los semiejes: x, -x, y, -y
  ctx.font = 'bold 13px sans-serif';
  ctx.fillStyle = '#1e3a8a';

  // Semieje X positivo (Derecha)
  ctx.textAlign = 'right';
  ctx.textBaseline = 'middle';
  ctx.fillText('x', ancho - 10, centroY - 15);

  // Semieje X negativo (Izquierda)
  ctx.textAlign = 'left';
  ctx.textBaseline = 'middle';
  ctx.fillText('-x', 10, centroY - 15);

  // Semieje Y positivo (Arriba)
  ctx.textAlign = 'left';
  ctx.textBaseline = 'top';
  ctx.fillText('y', centroX + 10, 10);

  // Semieje Y negativo (Abajo)
  ctx.textAlign = 'left';
