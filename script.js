...
// renderizada) y devuelve el HTML combinado de dos verificaciones
// independientes: (1) la CANTIDAD de soluciones y (2) el VALOR de
// cada solución.
function verificarIntentoEstudiante(intento, contenedorResultado) {
  ...
  return cajaCantidad + cajaValores;
}
